...
object InitialData {
    ...
    val initialApps = listOf(
        AppEntity(
            ...
            apkUrl = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1000",
            fileUrl = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1000",
            fileFormat = "APK",
        ...
        AppEntity(
            ...
            apkUrl = "",
            xapkUrl = "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1000",
            fileUrl = "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1000",
            fileFormat = "XAPK",
        ...
        AppEntity(
            ...
            apkUrl = "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1000",
            fileUrl = "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1000",
            fileFormat = "APK",
            downloadCount = 98200,
            rating = 4.7f,
            ratingCount = 8900,
        ...
        AppEntity(
            ...
            apkUrl = "",
            xapkUrl = "https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=1000",
            fileUrl = "https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=1000",
            fileFormat = "XAPK",
        ...
        AppEntity(
            ...
            apkUrl = "https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=1000",
            fileUrl = "https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=1000",
            fileFormat = "APK",
        ...
        AppEntity(
            ...
            apkUrl = "",
            xapkUrl = "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?w=1000",
            fileUrl = "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?w=1000",
            fileFormat = "XAPK",
        ...
        AppEntity(
            id = "app_apex_chat",
            name = "APEX Connect & Chat",
            type = "APP",
            developer = "Apex Global Communications",
            shortDescription = "تطبيق مراسلة فورية مشفر بالكامل ومكالمات صوت وفيديو فائقة الدقة والخصوصية.",
            description = "تواصل بأمان وحرية مع الأصدقاء والعائلة. تشفير تام من طرف إلى طرف (End-to-End)، مشاركة ملفات حتى 2 جيجابايت، غرف محادثة جماعية ذكية بدون إعلانات مزعجة.",
            version = "2.1.0",
            size = "38.0 MB",
            packageName = "com.apex.connect.chat",
            androidVersion = "Android 8.0+",
            category = "social",
            iconUrl = "https://images.unsplash.com/photo-1611746872915-64382b5c76da?w=200",
            bannerUrl = "https://images.unsplash.com/photo-1611746872915-64382b5c76da?w=800",
            apkUrl = "https://images.unsplash.com/photo-1611746872915-64382b5c76da?w=1000",
            fileUrl = "https://images.unsplash.com/photo-1611746872915-64382b5c76da?w=1000",
            fileFormat = "APK",
        ...
        AppEntity(
            id = "game_clash_of_empires",
            name = "Clash of Empires: World War",
            type = "GAME",
            developer = "Kingdom Forge Games",
            shortDescription = "لعبة استراتيجية ملحمية لبناء القلاع وتحريك الجيوش والتحالفات العالمية.",
            description = "ابنِ إمبراطوريتك العظمى وقد جيوش الفرسان والرماة في معارك تكتيكية حية. ابنِ التحالفات مع اللاعبين حول العالم وخض حروب الحصار للسيطرة على العرش الملكي.",
            version = "1.8.4",
            size = "780 MB",
            packageName = "com.kingdomforge.clashofempires.xapk",
            androidVersion = "Android 8.0+",
            category = "strategy",
            ...
            apkUrl = "",
            xapkUrl = "https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=1000",
            fileUrl = "https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=1000",
            fileFormat = "XAPK",
